...
PARSER = BlackStack::SimpleCommandLineParser.new(
    ...
    :configuration => [{
        ...
        :name=>'auto_deletion_batch_size',
        :mandatory=>false,
        :default=>100, # 100 accounts
        :description=>'Batch size for accounts auto-deletion. Default is 100 accounts.', 
        :type=>BlackStack::SimpleCommandLineParser::INT,
    }, {
        :name=>'auto_deletion_inactivity_days',
        :mandatory=>false,
        :default=>30, # 30 days
        :description=>'Inactivity days for accounts auto-deletion. Default is 30 days.', 
        :type=>BlackStack::SimpleCommandLineParser::INT,
    }]
)
...
while true
    begin
        ...
        BlackStack::Drainer.run(
            logger:l,
            auto_deletion_batch_size: PARSER.value('auto_deletion_batch_size'),
            auto_deletion_inactivity_days: PARSER.value('auto_deletion_inactivity_days')
        )
