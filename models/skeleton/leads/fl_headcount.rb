module BlackStack
module Leads
  class Headcount < Sequel::Model(:fl_headcount)
    ...
    def self.validate_descriptor(h)
      ...
      if h['code'].is_a?(String)
        if !BlackStack::Leads::Headcount.where(:name=>h['code']).first
    ...
    def initialize(h)
      super()
      errors = BlackStack::Leads::Headcount.validate_descriptor(h)
      raise "Errors found:\n#{errors.join("\n")}" if errors.size>0
  ...
  end # def BlackStack::Leads::Revenue
end # module Leads
