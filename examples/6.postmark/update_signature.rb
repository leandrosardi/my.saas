# This example shows how to change the name of an existing signature in PostMark.
...
# create sender
begin
    sender_name = 'Leandro Sardi - Connectionsphere'
    id = '4217384'
    ret = client_postmark.update_sender(id, name: sender_name)
