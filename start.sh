...
#ruby $HOME/code/code/app/p/dispatcher.rb > /dev/null 2>&1 &
#ruby $HOME/code/code/app/p/worker.rb > /dev/null 2>&1 &
#ruby $HOME/code/code/app/extensions/i2p/p/ipn.rb > /dev/null 2>&1 &
